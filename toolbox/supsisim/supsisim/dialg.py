...
class RTgenDlg(QDialog):
    def __init__(self, parent=None):
        ...
        lab4 = QLabel('Additional Build Args')
        self.addBuildArgs = QLineEdit('')

        lab5 = QLabel('Priority')
        self.prio = QLineEdit('')

        lab6 = QLabel('Sampling Time')
        self.Ts = QLineEdit('')

        lab7 = QLabel('Final Time')
        self.Tf = QLineEdit('')
        ...
        grid.addWidget(self.addBuildArgs, 3, 1)
        grid.addWidget(lab5, 4, 0)
        grid.addWidget(self.prio, 4, 1)
